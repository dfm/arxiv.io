...
client_key = unicode(os.environ.get("TW_CLIENT_KEY"))
client_secret = unicode(os.environ.get("TW_CLIENT_SECRET"))
user_key = unicode(os.environ.get("TW_USER_KEY"))
user_secret = unicode(os.environ.get("TW_USER_SECRET"))
                    ...
                    try:
                        for line in r.iter_lines():
                            if line:
                                ...
                                fn = "tweets/{0}.json".format(tweet["id"])
                                with open(fn, "w") as f:
                                    f.write(line)
